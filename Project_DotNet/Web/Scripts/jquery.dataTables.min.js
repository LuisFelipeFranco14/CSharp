...
e.sInstance, this.oApi._fnJsonString(i), e.iCookieDuration, e.sCookiePrefix, e.fnCookieCallback)
        }, fnStateSaveParams: null, iCookieDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iScrollLoadGap: 100, iTabIndex: 0, oLanguage: { oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: { sFirst: "Primeira", sLast: "Última", sNext: "Pr&oacute;ximo", sPrevious: "Anterior" }, sEmptyTable: "Nao foi carregado nenhuma informacao.", sInfo: "Visualizando _START_ de _END_ de _TOTAL_ registros",
            sInfoEmpty: "Visualizando 0 de 0 de 0 registros", sInfoFiltered: "(filtrado de um total de _MAX_ registros)", sInfoPostFix: "", sInfoThousands: ",", sLengthMenu: "Show _MENU_ entries", sLoadingRecords: "Carregando...", sProcessing: "Processando...", sSearch: "Localizar:", sUrl: "", sZeroRecords: "Nao foi carregado nenhuma informacao."
