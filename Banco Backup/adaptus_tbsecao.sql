...
CREATE TABLE `tbsecao` (
  ...
  `descricao_sem_caracter` varchar(180) DEFAULT NULL,
  `descricao_com_caracter` varchar(180) DEFAULT NULL,
...
INSERT INTO `tbsecao` VALUES (1,'cadastro','Cadastros','fa-users'),(2,'sistema','Sistema','fa-laptop');
